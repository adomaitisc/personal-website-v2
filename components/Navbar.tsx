...
const Navbar = () => {
  return (
    <>
      <div className="mt-4 mx-auto w-72 fixed top-0 left-0 right-0 flex items-center justify-center bg-black/40 backdrop-blur-lg rounded-full font-kng text-sm border border-white/20">
